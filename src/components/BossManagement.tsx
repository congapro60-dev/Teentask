...
import { ShieldCheck, UserPlus, Search, Trash2, User, Mail, ShieldAlert, CheckCircle2, XCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-black text-gray-900 tracking-tight">QUẢN LÝ ADMIN</h1>
          <p className="text-gray-500 text-sm">Bổ nhiệm và giám sát các tài khoản quản trị viên</p>
        </div>
      </div>
